...
void test_validate_my_username()
{
    ...
    const char* user_name_static = my_username();
    const char* user_name_from_conf = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(user_name_static, user_name_from_conf, "Uh oh...");
}
